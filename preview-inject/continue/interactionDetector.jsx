...
/**
 * Detection result shapes (documented):
 * InteractionDetail: { hasEvents, react, native }
 * CheckResult: { error?, selector?, x?, y?, hasEvents?, detail? }
 */
 ...
 */
export function getInteractionEventsDetail(element) {
 ...
 */
export function checkMultiple(elements) {
 ...
 */
export function checkMultipleSelectors(selectors) {
