...
const postRouteWillChangeMessage = async (route, options) => {
...
function isGoogleRelatedAuth(url) {
...
function processNavigationAPI() {
  ...
  const navigateHandler = (e) => {
    if (isGoogleRelatedAuth(e.destination && e.destination.url)) {
      postMessageClient.post("google-auth-blocked", {
